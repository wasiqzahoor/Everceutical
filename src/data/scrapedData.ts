...
export interface ContentBlock {
  type: "heading" | "paragraph" | "list" | "image" | "table" | "quote" | "divider" | "resources"
  level?: number
  text?: string
  items?: string[]
  src?: string
...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Exosome-based therapeutics have rapidly emerged as a transformative modality in regenerative and aesthetic medicine. Among the multiple biologically derived exosome classes currently under investigation, Pneumofibroblast-derived exosomes (PF-Exosomes) are consistently ranked as a top-tier class, second only to HUC-MSC exosomes in clinical demand and biological efficacy.", links: [{ text: "Exosome-based therapeutics", url: "https://pubmed.ncbi.nlm.nih.gov/41800722/" }] },
      { type: "paragraph", text: "These exosomes are particularly valued for their exceptional extracellular matrix (ECM) signaling, fibrosis regulation, and tissue remodeling capacity, making them highly relevant for skin rejuvenation, wound healing, pulmonary tissue repair, and advanced aesthetic protocols.", links: [{ text: "extracellular matrix (ECM) signaling", url: "https://pubmed.ncbi.nlm.nih.gov/40433567/" }] },
      ...
      { type: "paragraph", text: "Pneumofibroblasts are a specialized subtype of fibroblasts primarily associated with pulmonary connective tissue, although their biological characteristics are also mirrored in dermal and interstitial fibroblast populations.", links: [{ text: "fibroblasts", url: "https://pubmed.ncbi.nlm.nih.gov/38164161/" }] },
      { type: "heading", level: 3, text: "Key Biological Functions of Pneumofibroblasts" },
      { type: "list", items: ["Regulation of extracellular matrix synthesis", "Controlled deposition of collagen I, III, and elastin", "Modulation of fibrotic vs regenerative signaling", "Crosstalk with epithelial and endothelial cells", "Secretion of paracrine vesicles, including exosomes"], links: [{ text: "Regulation of extracellular matrix synthesis", url: "https://pubmed.ncbi.nlm.nih.gov/32504772/" }, { text: "Crosstalk with epithelial and endothelial cells", url: "https://pubmed.ncbi.nlm.nih.gov/32477322/" }] },
      ...
      { type: "paragraph", text: "Pneumofibroblast-derived exosomes are nano-sized extracellular vesicles (typically 30–150 nm) released through the endosomal multivesicular body (MVB) pathway of pneumofibroblast cells.", links: [{ text: "nano-sized extracellular vesicles", url: "https://pubmed.ncbi.nlm.nih.gov/40613286/" }] },
      ...
      { type: "paragraph", text: "Growth Factors: TGF-β modulators (balanced, non-fibrotic), FGF-2 (Fibroblast Growth Factor), VEGF signaling mediators.", links: [{ text: "Growth Factors", url: "https://pubmed.ncbi.nlm.nih.gov/36455676/" }] },
      { type: "paragraph", text: "MicroRNAs (miRNAs): miR-21 (regulated ECM remodeling), miR-29 family (anti-fibrotic signaling), miR-146a (anti-inflammatory modulation).", links: [{ text: "miR-21, miR-29 family, miR-146a", url: "https://www.sciencedirect.com/science/article/pii/S2405580825004583" }] },
      ...
      { type: "list", items: ["Advanced skin rejuvenation protocols", "Scar and post-acne remodeling", "Anti-aging dermal regeneration", "Post-procedure tissue recovery", "Fibrosis modulation therapies"], links: [{ text: "skin rejuvenation", url: "https://pubmed.ncbi.nlm.nih.gov/42411735/" }, { text: "wound healing", url: "https://pubmed.ncbi.nlm.nih.gov/41146891/" }] },
      { type: "divider" },
      { type: "heading", level: 2, text: "Scientific Resources" },
      { type: "resources", links: [
        { text: "International Society for Extracellular Vesicles — MISEV2023 Guidelines", url: "https://www.isev.org/misev" },
        { text: "Fibroblast-derived exosomes and skin wound healing — PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/41146891/" },
        { text: "Fibroblast-derived exosomes and skin wound healing — PMC Full Text", url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC12630532/" },
        { text: "Fibroblast-derived regenerative skincare technologies — PubMed Review", url: "https://pubmed.ncbi.nlm.nih.gov/42411735/" },
        { text: "MISEV2023 scientific guidelines — PMC Full Text", url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC10850029/" }
      ] },
    ],
  },
  {
    ...
    content: [
      ...
      { type: "divider" },
      { type: "heading", level: 2, text: "Introduction" },
      { type: "paragraph", text: "Exosome-based therapies represent one of the most advanced frontiers in regenerative and aesthetic medicine. Among the various exosome sources available today, Human Umbilical Cord–derived Mesenchymal Stem Cell (HUC-MSC) exosomes are widely regarded as the gold standard in clinical practice due to their high bioactivity, safety profile, ethical acceptability, and regenerative signaling potency.", links: [{ text: "Exosome-based therapies", url: "https://pubmed.ncbi.nlm.nih.gov/32392899/" }] },
      { type: "heading", level: 2, text: "What Are Exosomes? (Scientific Definition)" },
      { type: "paragraph", text: "Exosomes are extracellular vesicles (EVs) with an average diameter of 30–150 nanometers, secreted naturally by living cells. They play a critical role in intercellular communication by transferring biologically active molecules, including growth factors, cytokines, lipids, proteins, mRNA and microRNA (miRNA).", links: [{ text: "extracellular vesicles (EVs)", url: "https://isevjournals.onlinelibrary.wiley.com/doi/full/10.1002/jev2.12404" }] },
      ...
      { type: "list", items: ["Endocytosis — The cell membrane forms early endosomes", "Multivesicular Body (MVB) Formation — Intraluminal vesicles are generated inside endosomes", "Exosome Release — MVBs fuse with the plasma membrane, releasing exosomes into the extracellular space"], links: [{ text: "Biological Formation of Exosomes", url: "https://isevjournals.onlinelibrary.wiley.com/doi/full/10.1002/jev2.12404" }] },
      { type: "heading", level: 2, text: "Classification of Stem Cell–Derived Exosomes" },
      { type: "paragraph", text: "Exosomes are classified based on the parent cell of origin. Major clinical categories include: MSC-Derived Exosomes (Bone marrow, Adipose, Umbilical cord), Hematopoietic Stem Cell (HSC) Exosomes, Fibroblast-Derived Exosomes, and Immune Cell–Derived Exosomes.", links: [{ text: "MSC-Derived Exosomes", url: "https://pubmed.ncbi.nlm.nih.gov/41572796/" }] },
      ...
      { type: "paragraph", text: "HUC-MSC = Human Umbilical Cord Mesenchymal Stem Cells. Derived from Wharton's Jelly of the umbilical cord after full-term birth. No embryo is destroyed. No fetal or neonatal harm is involved.", links: [{ text: "Human Umbilical Cord Mesenchymal Stem Cells", url: "https://pubmed.ncbi.nlm.nih.gov/34344478/" }] },
      { type: "heading", level: 3, text: "Why Umbilical Cord–Derived MSCs Are Superior" },
      { type: "list", items: ["Extremely high proliferative capacity", "Low immunogenicity (immune-privileged)", "Strong paracrine signaling", "Rich in regenerative miRNAs and growth factors", "Free from age-related cellular damage"], links: [{ text: "Strong paracrine signaling", url: "https://pubmed.ncbi.nlm.nih.gov/41572796/" }] },
      { type: "heading", level: 2, text: "Exosome Extraction Process" },
      { type: "list", items: ["Ethically sourced umbilical cord tissue", "Isolation of HUC-MSCs in a GMP-compliant lab", "Cell expansion in controlled bioreactors", "Conditioned media collection (where exosomes are secreted)", "Exosome isolation and purification using ultracentrifugation, TFF, and size-exclusion chromatography"], links: [{ text: "ultracentrifugation, TFF, and size-exclusion chromatography", url: "https://isevjournals.onlinelibrary.wiley.com/doi/full/10.1002/jev2.12404" }] },
      ...
      { type: "paragraph", text: "HUC-MSC exosomes are widely used for scalp applications (androgenetic alopecia, telogen effluvium, post-transplant healing, follicular stem cell activation) and skin applications (skin rejuvenation, post-laser recovery, acne scarring, inflammation modulation).", links: [{ text: "HUC-MSC exosomes", url: "https://pubmed.ncbi.nlm.nih.gov/40751329/" }, { text: "hair restoration", url: "https://www.tandfonline.com/doi/full/10.2147/CCID.S543451" }, { text: "skin rejuvenation", url: "https://pubmed.ncbi.nlm.nih.gov/35182986/" }, { text: "wound healing", url: "https://pubmed.ncbi.nlm.nih.gov/34344478/" }] },
      ...
      { type: "resources", links: [
        { text: "International Society for Extracellular Vesicles — MISEV2023 Guidelines", url: "https://www.isev.org/misev" },
        { text: "MSC-derived exosomes for skin regeneration and immunomodulatory therapeutics — PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/32392899/" },
        { text: "HUC-MSC exosomes in wound healing and skin regeneration — PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/34344478/" },
        { text: "MSC-derived exosomes in immune modulation and regenerative medicine — PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/41572796/" },
        { text: "MSC-derived secretome and exosomes in dermatology — PubMed Review", url: "https://pubmed.ncbi.nlm.nih.gov/40751329/" },
        { text: "Exosomes and hair regeneration — Clinical evidence systematic review", url: "https://www.tandfonline.com/doi/full/10.2147/CCID.S543451" },
        { text: "Mesenchymal stem cell exosomes in skin photoaging — PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/35182986/" }
      ] },
    ],
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Exosome count is expressed as number of exosome particles per milliliter (particles/mL).", links: [{ text: "particles per milliliter (particles/mL)", url: "https://pubmed.ncbi.nlm.nih.gov/33667588/" }] },
      ...
      { type: "paragraph", text: "Exosome quantification is not estimated — it is instrumentally measured. Standard technologies include Nanoparticle Tracking Analysis (NTA), Tunable Resistive Pulse Sensing (TRPS), and Flow cytometry.", links: [{ text: "Exosome quantification", url: "https://pubmed.ncbi.nlm.nih.gov/39432269/" }, { text: "Nanoparticle Tracking Analysis (NTA)", url: "https://pubmed.ncbi.nlm.nih.gov/30022036/" }, { text: "Tunable Resistive Pulse Sensing (TRPS)", url: "https://pubmed.ncbi.nlm.nih.gov/30022036/" }] },
      ...
      { type: "list", items: ["Stem cell culture under GMP conditions", "Exosome secretion into conditioned media", "Isolation and purification (ultrafiltration / chromatography)", "Particle counting and concentration standardization", "Lyophilization of measured exosome quantity", "Sterile packaging with diluent"], links: [{ text: "Particle counting and concentration standardization", url: "https://pubmed.ncbi.nlm.nih.gov/41384862/" }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "divider" },
      { type: "heading", level: 2, text: "Introduction" },
      { type: "paragraph", text: "In the rapidly evolving field of regenerative aesthetics, exosome therapy is redefining treatment outcomes for hair restoration and skin rejuvenation. Unlike traditional approaches, exosomes harness the body's own communication systems to repair and regenerate at a cellular level — delivering visible, lasting transformations.", links: [{ text: "hair restoration and skin rejuvenation", url: "https://pubmed.ncbi.nlm.nih.gov/40751329/" }] },
      { type: "heading", level: 2, text: "What Makes Exosome Therapy Clinically Superior?" },
      { type: "paragraph", text: "Exosomes are nano-sized vesicles secreted by stem cells (particularly huC-MSCs) that carry vital signaling molecules — such as growth factors, peptides, and nucleic acids. When topically applied or delivered via microneedling, they activate and instruct local cells to:", links: [{ text: "growth factors, peptides, and nucleic acids", url: "https://isevjournals.onlinelibrary.wiley.com/doi/full/10.1002/jev2.12404" }] },
      { type: "list", items: ["Stimulate collagen and elastin for improved skin elasticity and firmness", "Reactivate dormant hair follicles, promoting stronger and thicker regrowth", "Reduce pigmentation, inflammation, and scar formation", "Accelerate healing post-treatment (microneedling, PRP, laser)"], links: [{ text: "Stimulate collagen and elastin", url: "https://pubmed.ncbi.nlm.nih.gov/35182986/" }, { text: "Reactivate dormant hair follicles", url: "https://pubmed.ncbi.nlm.nih.gov/39432269/" }, { text: "Accelerate healing post-treatment", url: "https://pubmed.ncbi.nlm.nih.gov/34344478/" }] },
      ...
      { type: "paragraph", text: "Before: Receding hairline, visible scalp, low follicular density. After: Enhanced hair thickness at the crown, regrowth along temporal zones, improved scalp coverage.", links: [{ text: "hair regrowth", url: "https://pubmed.ncbi.nlm.nih.gov/39432269/" }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Exosomes are extracellular vesicles secreted by stem cells — particularly mesenchymal stem cells (MSCs). These nano-sized vesicles are rich in growth factors, microRNAs, cytokines, and proteins that facilitate intercellular communication and tissue regeneration.", links: [{ text: "Exosomes are extracellular vesicles", url: "https://www.frontiersin.org/journals/medicine/articles/10.3389/fmed.2024.1457889/full" }] },
      { type: "heading", level: 3, text: "Exosome Mechanism of Action" },
      { type: "list", items: ["Reactivates quiescent or miniaturized follicles", "Delivers anti-inflammatory and immunomodulatory signals", "Stimulates extracellular matrix remodeling and angiogenesis", "Provides a concentrated, cell-free regenerative payload"], links: [{ text: "hair regeneration", url: "https://www.karger.com/Article/Abstract/524636" }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "divider" },
      { type: "paragraph", text: "huC-MSCs stands for Human Umbilical Cord-derived Mesenchymal Stem Cells. These are special types of stem cells that are collected from the Wharton's Jelly of healthy, donated umbilical cords after childbirth — with full ethical consent.", links: [{ text: "Human Umbilical Cord-derived Mesenchymal Stem Cells", url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC11933772/" }, { text: "Wharton's Jelly", url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC11933772/" }] },
      { type: "paragraph", text: "These cells are incredibly valuable in medical science because they are young and powerful (high regenerative capacity), carry no ethical concerns (unlike embryonic stem cells), and can transform into multiple types of cells like skin, bone, cartilage, and nerve cells.", links: [{ text: "high regenerative capacity", url: "https://pubmed.ncbi.nlm.nih.gov/41384862/" }, { text: "transform into multiple types of cells", url: "https://link.springer.com/article/10.1007/s12015-024-09742-5" }] },
      { type: "heading", level: 2, text: "Why Are HuC-MSCs Important?" },
      { type: "paragraph", text: "huC-MSCs are known for secreting biologically active molecules, including exosomes — tiny, nano-sized vesicles filled with growth factors, proteins, and genetic material. These exosomes are like 'healing messages' that travel to damaged cells and instruct them to repair, regenerate, and rejuvenate.", links: [{ text: "exosomes", url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC11933772/" }, { text: "growth factors, proteins, and genetic material", url: "https://www.sciencedirect.com/science/article/pii/S2405580825004583" }] },
      { type: "paragraph", text: "In skincare and hair restoration, huC-MSC-derived exosomes have shown remarkable benefits:" },
      { type: "list", items: ["Boosting collagen and elastin production", "Enhancing skin repair and anti-aging effects", "Reactivating dormant hair follicles", "Reducing inflammation and pigmentation", "Improving overall skin texture and hair density"], links: [{ text: "Boosting collagen and elastin production", url: "https://pubmed.ncbi.nlm.nih.gov/40751329/" }, { text: "Enhancing skin repair and anti-aging effects", url: "https://pubmed.ncbi.nlm.nih.gov/41384862/" }, { text: "Reducing inflammation", url: "https://pubmed.ncbi.nlm.nih.gov/41384862/" }] },
      { type: "paragraph", text: "Because they come from umbilical cord stem cells, the exosomes derived from huC-MSCs are younger, more potent, and more active compared to those derived from adult tissues.", links: [{ text: "younger, more potent, and more active compared to those derived from adult tissues", url: "https://pubmed.ncbi.nlm.nih.gov/35042021/" }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "divider" },
      { type: "paragraph", text: "Think of your body as a vast communication network. Inside this network, cells constantly 'talk' to each other by sending tiny messages. These messages? They're called exosomes.", links: [{ text: "extracellular vesicles (EVs)", url: "https://www.frontiersin.org/journals/physiology/articles/10.3389/fphys.2023.1260471/full" }] },
      { type: "paragraph", text: "Exosomes are microscopic particles (even smaller than cells!) that carry powerful information like proteins, growth factors, and genetic signals. Released by healthy cells, they act like messengers that tell other cells how to heal, repair, and regenerate.", links: [{ text: "cell-to-cell communication", url: "https://www.nature.com/articles/s41572-024-00549-w" }] },
      ...
      { type: "paragraph", text: "As we age, our skin naturally slows down its repair process. That's where exosome therapy for skin steps in. When exosomes are applied to the skin — whether through serums, microneedling, or PRP — they:", links: [{ text: "exosome biogenesis", url: "https://pubmed.ncbi.nlm.nih.gov/33667588/" }] },
      { type: "list", items: ["Stimulate collagen and elastin production", "Improve skin texture, tone, and elasticity", "Reduce fine lines, wrinkles, and pigmentation", "Speed up healing after procedures like microneedling or laser", "Enhance overall skin health and glow"], links: [{ text: "proteins, lipids, and nucleic acids", url: "https://www.nature.com/articles/s41572-024-00549-w" }] },
      ...
      { type: "paragraph", text: "Hair thinning or hair loss is a concern for many people. Exosome therapy for hair loss is emerging as a powerful, non-surgical solution. When applied to the scalp, exosomes:", links: [{ text: "multivesicular bodies (MVBs)", url: "https://pubmed.ncbi.nlm.nih.gov/33667588/" }] },
      { type: "list", items: ["Reactivate dormant hair follicles", "Promote new hair growth", "Increase hair thickness and density", "Reduce inflammation around follicles", "Support a healthier scalp environment"], links: [{ text: "uptake by recipient cells", url: "https://pubmed.ncbi.nlm.nih.gov/39432269/" }] },
